...
export function ShoppingScreen() {
    ...
    const doneList = useLiveQuery(async () => {
        ...
        try {
            ...
            if (raw) {
                ...
                localStorage.removeItem('forma:shop:' + weekStart);
                return list;
            }
        }
        catch { /* ignore */ }
    ...
    const setDone = (next) => { setSetting(key, [...next]); };
