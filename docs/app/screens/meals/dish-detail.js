...
export function DishDetailScreen({ id }) {
    ...
    if (dish === undefined)
        return _jsx(Screen, {});
    if (dish === null)
        return _jsx(Screen, { className: "screen-no-tabs", children: _jsx(Empty, { title: t('dish.notFound'), action: _jsx(Button, { variant: "secondary", onClick: () => navigate('/forma/meals/dishes'), children: t('dish.backToDishes') }) }) });
