...
export function WorkoutsScreen() {
    ...
    return (_jsxs(Screen, { children: [_jsx(TopBar, { large: true, title: t('workouts.title'), eyebrow: weekKcal > 0 ? t('workouts.kcalBurnedThisWeek', { n: weekKcal }) : t('workouts.countWorkouts', { n: workouts?.length ?? 0 }), right: _jsxs(_Fragment, { children: [_jsx(IconButton, { label: t('workouts.history'), onClick: () => navigate('/forma/workouts/history'), children: _jsx(IconHistory, { size: 20 }) }), _jsx(IconButton, { label: t('workouts.exerciseLibrary'), onClick: () => navigate('/forma/workouts/exercises'), children: _jsx(IconStar, { size: 20 }) }), _jsx(IconButton, { label: t('workouts.newWorkout'), tone: "accent", onClick: () => navigate('/forma/workouts/new'), children: _jsx(IconPlus, {}) })] }) }), _jsx(Section, { title: t('workouts.weeklySchedule'), right: _jsx("span", { children: t('workouts.tapDayToAssign') }), children: _jsx("div", { className: "calendar-week", children: order.map((wd) => {
