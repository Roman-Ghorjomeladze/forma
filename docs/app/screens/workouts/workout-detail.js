...
export function WorkoutDetailScreen({ id }) {
    ...
    if (workout === null)
        return _jsx(Screen, { className: "screen-no-tabs", children: _jsx(Empty, { title: t('workouts.notFound'), action: _jsx(Button, { variant: "secondary", onClick: () => navigate('/forma/workouts'), children: t('common.back') }) }) });
