...
export function ExerciseDetailScreen({ id }) {
    ...
    if (ex === null)
        return _jsx(Screen, { className: "screen-no-tabs", children: _jsx(Empty, { title: t('exercise.notFound'), action: _jsx(Button, { variant: "secondary", onClick: () => navigate('/forma/workouts/exercises'), children: t('common.back') }) }) });
