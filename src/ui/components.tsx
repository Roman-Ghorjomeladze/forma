...
// ---- controls ------------------------------------------------------------------------------
type Variant = 'primary' | 'secondary' | 'ghost' | 'danger' | 'meals' | 'dark' | 'pocket' | 'tree' | 'flags' | 'notes';
...
export function IconButton({ children, onClick, label, className = '', tone = 'default' }: { children: ReactNode; onClick?: () => void; label: string; className?: string; tone?: 'default' | 'accent' | 'meals' | 'danger' | 'pocket' | 'tree' | 'flags' | 'notes' }) {
...
export function Chip({ children, active = false, onClick, tone = 'default' }: { children: ReactNode; active?: boolean; onClick?: () => void; tone?: 'default' | 'meals' | 'workout' | 'pocket' | 'tree' | 'flags' | 'notes' }) {
